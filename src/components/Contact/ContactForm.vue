<template>
    ...
    <div class="container">
        ...
        <form id="contact-form" 
            ...
            action="https://getform.io/f/8506e178-2c50-4382-ae27-7d130d671e56" 
            method="POST">
    ...
    export default {
        ...
        data() {
            return {
                ...
                text: "Si tienes preguntas sobre nuestra plataforma o quieres formar parte de nuestros auspiciantes, escríbenos",
                btnName: "Enviar ahora"
            }
        }
    }
</script>