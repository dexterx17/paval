        ...
        <form @submit.prevent="submit" v-if="showForm" class="w-full max-w-lg mx-auto py-1">
            ...
            <div class="flex flex-wrap -mx-3 mb-4">
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    <label
                        class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2"
                        for="grid-fecha_constitucion"
                    >Fecha de constitución</label>
                    <input
                        class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                        id="grid-fecha_constitucion"
                        type="date"
                        placeholder="Ej: 01/15/2022"
                        v-model="clubData.fecha_constitucion"
                        required
                    />
                </div>
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <input
                        ...
                        id="grid-resolucion"
                        type="text"
                        placeholder="Ej: ASDF#2334"
                        v-model="clubData.resolucion"
                        required
                    />
                </div>
            </div>
