<template>
    <div class="container relative" v-if="gameData">
        ...
        <h2 class="text-white font-bold uppercase xl:text-title lg:text-5xl md:text-4xl sm:text-3xl text-2xl xl:leading-70 lg:leading-12 leading-10">{{gameData.nombre}}</h2>
