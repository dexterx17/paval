        ...
        <div class="container">
            <div class="error_inner text-center">
                ...
                <div class="title text-white mb-16">
                    ...
                    <p class="sm:text-4xl text-2xl uppercase font-bold">LO SENTIMOS, esta página no fue encontrada.</p>
                </div>
                ...
                <div class="flex justify-center">
                    <RouterLink to="/" class="group primary-btn opacity-100 transition-all" style="background-image:url(/images/others/btn-bg.webp)">
