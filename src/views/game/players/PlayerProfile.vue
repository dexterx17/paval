            ...
            <div class="flex md:flex-row flex-col bg-secondary-100 p-8 md:p-68 rounded-50">
                <div class="md:w-2/5">
                    ...
                    <div class="flex flex-col justify-center items-center relative mt-8 max-w-full md:max-w-sm z-10 py-7">
                        ...
                        <span class="text-white text-sm md:text-base transition-all">{{playerData.nacionalidad}} <small>{{ playerData.ciudad }}</small> </span>
                        <span class="text-white text-sm md:text-base transition-all"> 0 <small>pts</small> </span>
